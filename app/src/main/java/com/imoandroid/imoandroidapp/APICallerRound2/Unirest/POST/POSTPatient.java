...
public class POSTPatient extends AsyncTask<String, Integer, HttpResponse<String>> {

    protected HttpResponse<String> doInBackground(String... msg) {
        HttpResponse<String> request = null;

        try {
            request = Unirest.post("http://66.252.70.193/patients")
...
//                    .body("{\"firstName\":\"sam\", \"lastName\":\"chop\"}")
            ...
            Log.v("SEDFGGGTRT", request.getBody());
