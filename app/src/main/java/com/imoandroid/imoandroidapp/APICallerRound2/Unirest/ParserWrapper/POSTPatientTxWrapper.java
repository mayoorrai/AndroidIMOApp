 ...
 */
public class POSTPatientTxWrapper {
    public static void poster(Patient patient, Term term) throws JsonProcessingException, JSONException {
        ...
        new POSTPatientMethod().execute(String.valueOf(patient.getDemo().getId()) , patient.getDemo().getFirstName(), patient.getDemo().getLastName() ,"tx", initObj.toString());
